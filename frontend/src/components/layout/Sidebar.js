...
import { X, Calendar, Clock, History, UserCircle, Settings, LogOut, Home } from 'lucide-react';
          ...
          <nav className="flex-1 overflow-y-auto p-4">
            <ul className="space-y-2">
              {[
                ...
                { icon: Calendar, text: 'Book Appointment', id: 'doctorslist' },
                { icon: Clock, text: 'Upcoming Appointments', id: 'upcoming' },
                { icon: Clock, text: 'Schedule', id: 'schedule' },
